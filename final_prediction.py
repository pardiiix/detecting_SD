...
#counting polarity values (sd vs. nsd)
print("value counts of abdominal comments", ab_df['polarity'].value_counts())
print("value counts of depression comments",dep_df['polarity'].value_counts())
print("value counts of knee comments",knee_df['polarity'].value_counts())
print("value counts of memory loss comments",mem_df['polarity'].value_counts())
