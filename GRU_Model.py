...
model.add(GRU(128, return_sequences=False, name = 'lstm_layer'))
...
history = model.fit(X_train, y_train, batch_size=32, epochs=4, verbose = 1, validation_split =0.2) #verbose =1 : see trainig progress for each epoch
